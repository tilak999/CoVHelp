...
export default function Home() {
  ...
  return (
    <div className="bg-blue-200 min-h-screen p-2">
      ...
      {appData.notice && appData.notice != "" ? <div className="container mx-auto bg-white rounded-lg border-l-4 border-yellow-600 p-4 mt-4">
        <h1 className="font-bold text-yellow-600">Notice</h1>
        <p className="text-sm my-2" dangerouslySetInnerHTML={{ __html: appData.notice }}></p>
      </div> : ''}
      ...
      <div className="container mx-auto bg-white rounded-lg border-l-4 border-green-600 p-4 mt-4">
        ...
        <p className="my-2">In this tough time, we need each other to help ourselves. We welcome any help and suggestions to make this listing helpful.</p>
        <div className="rounded-lg p-4 bg-green-200 float-left my-1 mr-3">
          <svg height="15pt" width="15pt" viewBox="-23 -21 682 682.66669" xmlns="http://www.w3.org/2000/svg">
